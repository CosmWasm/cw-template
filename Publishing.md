...
Build results like optimized wasm code or expected hash don't need to be updates
since the don't belong to the source publication and are excluded in `Cargo.toml` with
